    ...
    days: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { time: "2:40–4:00",   task: "LeetCode: Merge Sorted Array + Binary Search (Linear vs Binary Search, writing test cases for every question)", tag: "DSA" },
    ...
    days: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { time: "2:40–4:00",   task: "LeetCode 30 Days JS — 3 questions (React Components DSA - traversing state trees)", tag: "DSA" },
      ...
      },
      {
        ...
        blocks: [
          ...
          { time: "LUNCH",       task: "Lunch Break", tag: "BREAK" },
          { time: "1:00–2:30",   task: "HackerRank: Left Rotation + New Year Chaos (Component-based question - React)", tag: "DSA" },
      ...
      },
      {
        ...
        blocks: [
          ...
          { time: "LUNCH",       task: "Lunch Break", tag: "BREAK" },
          { time: "1:00–3:00",   task: "Polish GitHub repo: Application principles and systematic decisions made", tag: "PROJECT" },
      ...
      },
      {
        ...
        blocks: [
          ...
          { time: "2:30–4:00",   task: "LeetCode 30 Days JS — 3 more questions (Focus on Two Pointer technique)", tag: "DSA" },
    ...
    days: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { time: "2:30–4:30",   task: "LeetCode: Number of Islands + Course Schedule (Include Binary Tree traversal basics)", tag: "DSA" },
      ...
      },
      {
        ...
        blocks: [
          ...
          { time: "LUNCH",       task: "Lunch Break", tag: "BREAK" },
          { time: "1:00–2:30",   task: "HR prep: '3W' methodology (Why this, Why doing this, Why not other things), Scenario-based questions", tag: "INTERVIEW" },
      ...
      },
      {
        ...
        blocks: [
          { time: "9:00–12:00",  task: "Simulate a remote assignment: build a JS app in 3 hours (Optimize for ATS Machine searching)", tag: "PROJECT" },
          { time: "LUNCH",       task: "Lunch Break", tag: "BREAK" },
      ...
      },
      {
        ...
        blocks: [
          { time: "9:00–11:00",  task: "Full timed mock: 2 hrs (Assessment strategies & simulated tech screening)", tag: "REVIEW" },
